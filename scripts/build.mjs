...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">
...
const header = (active, rel) => {
  ...
  return `<header class="nav"><div class="wrap nav-in">
    <a href="${rel}index.html" class="brand"><span class="brand-logo"><img src="${rel}assets/img/nevic-logo.png" alt="Nevic Labs"></span><span class="brand-name">Nevic Labs<small>Elevating Experiences</small></span></a>
